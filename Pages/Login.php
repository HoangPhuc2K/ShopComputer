              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Chào mừng bạn đến với BookShop</h1>
                  </div>
                  <p style = "color : red;"><?php session_start();
                          if(isset($_SESSION['KiemTra'])){
                            if($_SESSION['KiemTra'] == false){
                              echo 'Kiểm tra lại email và mật khẩu của bạn';
                              $_SESSION['KiemTra'] = true;
                            }
                          }
                          if(isset($_SESSION['HienTrangTK'])){
                            if($_SESSION['HienTrangTK'] == true){
                  ...
                  <form class="user" action ="../index.php" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nhập Email" name = "username">
                    </div>
                    <div class="form-group">
